...
function Game:init_item_prototypes()
    ...
    self.P_TAGS = {
        ...
        tag_juggle =        {name = 'Juggle Tag',       set = 'Tag', discovered = false, min_ante = 2, order = 19, config = {type = 'round_start_bonus', h_size = 1}, pos = {x = 5,y = 1}},
    ...
    self.P_CENTERS = {
        ...
        j_stencil=          {order = 17,  unlocked = true,  discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 2, cost = 8, name = "Joker Stencil", pos = {x=2,y=5}, set = "Joker", effect = "Hand Size Mult", cost_mult = 1.0, config = {extra = 1, Xmult = 1}},
        ...
        j_loyalty_card=     {order = 25,  unlocked = true,  discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 2, cost = 5, name = "Loyalty Card", pos = {x=4,y=2}, set = "Joker", effect = "1 in 10 mult", cost_mult = 1.0, config = {extra = {Xmult = 4, every = 6, remaining = "5 remaining"}}},
        j_8_ball=           {order = 26,  unlocked = true,  discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 1, cost = 5, name = "8 Ball", pos = {x=0,y=5}, set = "Joker", effect = "Spawn Tarot", cost_mult = 1.0, config = {extra=2}},
        ...
        j_space=            {order = 45,  unlocked = true,  discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 2, cost = 5, name = "Space Joker", pos = {x=1,y=8},set = "Joker", effect = "Upgrade Hand chance", cost_mult = 1.0, config = {extra = 4}},
        j_egg=              {order = 46,  unlocked = true,  discovered = false, blueprint_compat = false, perishable_compat = true, eternal_compat = true, rarity = 1, cost = 3, name = 'Egg', pos = {x = 0, y = 10}, set = 'Joker', config = {extra = 4}},
        ...
        j_stone=            {order = 89,  unlocked = true,  discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 2, cost = 6, name = "Stone Joker", pos = {x=9,y=0}, set = "Joker", effect = "Stone Card Buff", cost_mult = 1.0, config = {extra = 30}, enhancement_gate = 'm_stone'},
        ...
        j_arrowhead=        {order = 118,  unlocked = false, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 2, cost = 7, name = "Arrowhead", pos = {x=3,y=5}, set = "Joker", effect = "", config = {extra = 50}, unlock_condition = {type = 'modify_deck', extra = {count = 30, suit = 'Spades'}}},
        ...
        j_stuntman=         {order = 136,  unlocked = false, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 2, cost = 7, name = "Stuntman", pos = {x=8,y=6}, set = "Joker", effect = "", config = {extra = {h_size = 2, chip_mod = 250}}, unlock_condition = {type = 'chip_score', chips = 100000000}},
		...
		--CUSTOM JOKERS--CUSTOM JOKERS--CUSTOM JOKERS--CUSTOM JOKERS--CUSTOM JOKERS--CUSTOM JOKERS--
		
		--Cobblestone Joker
        j_cobble=
		{order = 151,
		name = "Cobblestone Joker",
		set = "Joker",
		effect = "Stone Card Mult",
		rarity = 1,
		cost = 4,
		unlocked = true,
		discovered = false,
		...
		eternal_compat = true,
		pos = {x=1,y=16},
		config = {extra = {Xmult = 1000, odds = 100}}},
		...
		name = "Framework", 
		set = "Joker", 
		effect = "Please give me a Blueprint I NEED IT", 
		rarity = 2, 
		cost = 7, 
		unlocked = true,  
		discovered = false, 
		...
		name = "Hoarder", 
		set = "Joker", 
		effect = "Mult for each Consumables", 
		rarity = 1, 
		cost = 5, 
		unlocked = true,  
		discovered = false, 
		...
		name = "Chromahand", 
		set = "Joker",
		effect = "Card in hand to Polychrome",
		rarity = 1, 
		cost = 4, 
		unlocked = true,  
		discovered = false, 
		...
		eternal_compat = false, 
		pos = {x = 6, y = 20}, 
		config = {extra = {dollars = 500, odds1 = 1500, odds2 = 750}}},
		...
		eternal_compat = true,
		pos = {x=8,y=20},
		config = {extra = {Xchip = 3, basechips = 25}}},
		...
		eternal_compat = true,
		pos = {x=4,y=21},
		config = {extra = {Xmult = 2, Xchips = 3, toggle = 1}}}, --1 means it always starts at Xmult
		...
		name = "Multi-Tool",
		set = "Joker",
		effect = "+chipNmult face card destroy",
		rarity = 2,
		cost = 6,
		unlocked = true, 
		discovered = false,
		...
		eternal_compat = true,
		pos = {x=7,y=21},
		config = {extra = {mult = 5, chips = 0, chip_mod = 20}}}, 
		...
		name = "Eye for an Eye",
		set = "Joker",
		effect = "Xchips when bonus card gone",
		rarity = 2,
		cost = 7,
		unlocked = true, 
		discovered = false,
		...
		eternal_compat = false,
		pos = {x=0,y=22},
		config = {extra = {chip = 15, odds = 3}}, 
		no_pool_flag = 'garlic_extinct'},
		...
		no_pool_flag = 'red_pepper_flakes_extinct'},
		...
		name = "Aglio e Olio",
		set = "Joker",
		effect = "Da Final Boss Dish Joker",
		rarity = 2,
		cost = 6,
		unlocked = true, 
		discovered = false,
		...
		eternal_compat = false,
		pos = {x=4,y=22},
		config = {extra = {Xmult = 0.05, Xchip = 0.1, odds = 1000}}, 
		...
		eternal_compat = true,
		pos = {x=5,y=22},
		config = {extra = {dollars = 6, mult = 15, chips = 50, Xmult = 2, Xchips = 2, toggle = 1}}}, 
		...
		name = "Fragility", 
		set = "Tarot", 
		effect = "Derank Selected Cards", 
		cost = 3, 
		cost_mult = 1.0, 
		discovered = true, 
		consumeable = true, 
		pos = {x=7,y=5}, 
		config = {mod_conv = 'down_rank', max_highlighted = 2}},
        ...
        c_hex=              {order = 13,   discovered = false, cost = 4, consumeable = true, name = "Hex", pos = {x=2,y=5}, set = "Spectral", config = {extra = 1}},
		...
		--CUSTOM SPECTRALS--CUSTOM SPECTRALS--CUSTOM SPECTRALS--CUSTOM SPECTRALS
      ...
      G.E_MANAGER:add_event(Event({
        ...
        func = (function()
            ...
            G.E_MANAGER:add_event(Event({trigger = 'after',delay = 0.2,func = (function()
                local SC_scale = 1.2
                SC = Card(G.ROOM.T.w/2 - SC_scale*G.CARD_W/2, 10. + G.ROOM.T.h/2 - SC_scale*G.CARD_H/2, SC_scale*G.CARD_W, SC_scale*G.CARD_H, G.P_CARDS.empty, G.P_CENTERS['j_acehole']) --joker in splash card
            ...
            if _ch.rules then
                ...
                if _ch.rules.custom then
                    for k, v in ipairs(_ch.rules.custom) do
						...
						elseif v.id == 'spectral_shop' then
							self.spectral_rate = 2
                        else
