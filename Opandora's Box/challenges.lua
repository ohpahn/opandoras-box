G.CHALLENGES = {
    ...
    },
    {
        ...
        jokers = {
            ...
            {id = 'j_cobble', eternal = true},
            {id = 'j_ooga', eternal = true},
            {id = 'j_miner', eternal = true}
        },
        consumeables = {
        },
        vouchers = {
        ...
        },
    {
        ...
        jokers = {
			{id = 'j_cicero', edition = 'negative', eternal = true},
			{id = 'j_cicero', edition = 'negative', eternal = true},
        },
        consumeables = {
        },
