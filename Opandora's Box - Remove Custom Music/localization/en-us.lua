return {
    descriptions={
        ...
        Joker={
            j_8_ball={
                ...
                text={
                    ...
                    "each played {C:attention}8{} to create a",
            ...
            j_drivers_license={
                ...
                text={
                    ...
                    "at least {C:attention}10{} Enhanced",
            ...
            j_inferno={
                ...
                text={
					...
					"{X:red,C:white} X#1# {} Mult, then",
					"gets {C:attention}destroyed{}",
                },
            },
            j_void={
                name="Void",
            ...
            j_hoarder={
                ...
                text={
                    "{C:red}+#1#{} Mult for each",
					"{C:attention}consumable cards held",
                },
            },
            j_last_resort={
                name="Last Resort",
            ...
            j_lord={
                name="Oh, Lord",
                text={
                    "Creates {C:tarot}The Emperor{}",
					"if played card has a",
            ...
            j_pendulum={
                ...
                text={
					...
					"after each hand played",
					"{C:inactive}Currently {X:purple,C:white}x#3#",
                },
            },
            j_sacrificial={
            ...
            j_mezzetino={
                name="Mezzetino",
                text={
					"Earn {C:attention}quintuple{} the {C:attention}sell value{}",
					"of all other Jokers held",
					"{C:attention}+1 card slot{} in",
					"shop when {C:attention}sold",
					"{C:inactive}(Currently {C:money}$#2#{C:inactive})",
                },
            },
            j_tab={
        ...
        }, -- END OF CUSTOM JOKER DESCRIPTIONS
        Other={
            black_sticker={
                name="Black Sticker",
                text={
        ...
        Spectral={
            ...
            c_summon={
                ...
                text={
                    ...
                    "{s:0.8,C:spectral}Summon, Soul, and Black Hole{s:0.8} excluded",
                },
            },
        },
        Stake={
        ...
        Tag={
            ...
            tag_d_six={
                ...
                text={
                    ...
                    "start at {C:money}$-1",
                    "{C:inactive}(Minimum of 2 free rerolls when having no vouchers){C:inactive}",
                },
            },
            tag_double={
                name="Double Tag",
    ...
    misc={
        ...
        challenge_names={
			...
			c_cicero_1="Cicero's Wrath",
            c_rock_1="Rock Hard Deck",
            c_testing_1="Testing Grounds",
        },
        collabs={
            Clubs={
                ["1"]="Default",
        ...
        dictionary={
            ...
            k_wins="Wins",
			--starting lines for the custom jokers
			k_mafia="Finito!",
			...
			--ending lines for the custom jokers
